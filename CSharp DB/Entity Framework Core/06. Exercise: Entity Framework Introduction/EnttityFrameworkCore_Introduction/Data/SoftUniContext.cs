namespace SoftUni.Data
{
    ...
    {
        // We use this constructor, since the default connection string is our DB and Server
        public SoftUniContext()
        {

        }

        // Judge uses this constructor
        // Judge passes options matching local DB in the Judge Server
